![cabrnet logo](https://github.com/aiser-team/cabrnet/blob/main/docs/manuals/imgs/banner.png)
...
# Documentation
The full documentation is available on the [GitHub repository](https://github.com/aiser-team/cabrnet).