...
it is also easy to [add new applications](manuals/applications.md).
...
- `--model-config /path/to/file.yml` indicates how to [build and initialize the model](manuals/model.md).
- `--dataset|-d /path/to/file.yml` indicates how to [load and prepare the data for training](manuals/data.md).
- `--training|-t /path/to/file.yml` indicates the [training parameters of the model](manuals/optimizers.md).
- `--visualization /path/to/file.yml` indicates how to [visualize the prototypes and patches of test image](manuals/visualize.md).
...
- `--resume-from /path/to/checkpoint/directory` indicates the directory from which the training process should resume. If not provided, the training process starts from the first epoch. More precisely, each training checkpoint directory contains:
    - a copy of the YML file describing the model architecture, as specified [here](manuals/model.md).
    - a copy of the YML file describing the dataset, as specified [here](manuals/data.md). 
    - a copy of the YML file describing the training configuration, as specified [here](manuals/optimizers.md). 
...
- `--model-config /path/to/file.yml` indicates how to [build the model](manuals/model.md). In addition,
...
- `--dataset|-d /path/to/file.yml` indicates how to [load and prepare the data for prototype projection](manuals/data.md).
- `--training|-t /path/to/file.yml` indicates the [parameters of the epilogue](manuals/optimizers.md) (if any).
- `--visualization /path/to/file.yml` indicates how to [visualize the prototypes](manuals/visualize.md).
...
- `--dataset|-d /path/to/file.yml` indicates how to [load and prepare the test data for the evaluation](manuals/data.md).
...
[build and initialize the model](manuals/model.md).
...
- `--dataset|-d /path/to/file.yml` indicates how to [prepare the image](manuals/data.md) before it is processed by the model,
based on the transformations applied to the *test* dataset.
- `--visualization /path/to/file.yml` indicates how to [visualize the patches of the test image](manuals/visualize.md).
- `--prototype-dir path/to/prototype/directory` indicates where the prototype visualizations extracted during 
[training](#training-) are stored (usually in `<training_directory>/prototypes/`).
