...
from cabrnet.interface.utils import create_browse_folder_component
from cabrnet.utils.prototypes import prototype_init_modes
from cabrnet.utils.tree import leaf_init_modes
...
supported_architectures = {
    "ProtoPNet": {
        "top_arch": {"module": "cabrnet.protopnet.model", "name": "ProtoPNet"},
        "classifier": {
    ...
    "ProtoTree": {
        "top_arch": {"module": "cabrnet.prototree.model", "name": "ProtoTree"},
        "classifier": {
