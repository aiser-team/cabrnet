...
import cabrnet.evaluation.local_perturbation_analysis
import cabrnet.evaluation.relevance_analysis
from cabrnet.utils.data import DatasetManager
from cabrnet.utils.monitoring import metrics_to_str
from cabrnet.utils.save import load_projection_info
from cabrnet.interface.utils import create_browse_folder_component, gradio_convert_outputs
from cabrnet.interface.visualization import create_visualization_gui, get_visualization_config
from cabrnet.interface.benchmark import (
    ...
    def benchmark_callback(self) -> Callable:
        ...
        def callback(gradio_outputs: dict[Component, Any]) -> Image.Image | None:
            ...
            if gradio_config["benchmark_selection"] == "Local perturbation analysis":
                cabrnet.evaluation.local_perturbation_analysis.analyze(
                    model=self.model,
                    img=gradio_config["input_image"],
                    img_id="",
                    preprocess=preprocess,
